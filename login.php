...
<head>
	...
	<title>Zeea Laundry | Login</title>
...
<body>
	...
	<?php if (isset($_SESSION['login']) && isset($_SESSION['master'])) : ?>
		<script>window.location='http://localhost/zeea_laundry/'</script>
	<?php endif ?> 
		...
		<div class="box-content">
			...
			<div class="col box__right">
				<div class="box__right-content">
					...
					<img src=" <?=url('_assets/img/laundry2.png')?>" alt="" class="box-img-orang">
	...
	<div class="copyright">
		<p>&copy; <span id="tahun"></span> Destio Wahyu</p>
		<script>
